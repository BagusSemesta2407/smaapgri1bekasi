                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label for="tipe_pembayaran">Tipe Pembayaran <small>(Cth: BRI, BNI, DANA,
                                                        dll)</small></label>
                                                <input type="text" id="tipe_pembayaran"
                                                    class="form-control @error('tipe_pembayaran') is-invalid @enderror"
                                                    placeholder="Tipe Pembayaran" name="tipe_pembayaran"
                                                    value="{{ old('tipe_pembayaran', @$setting->tipe_pembayaran) }}">
                                                @error('tipe_pembayaran')
                                                    <span class="text-danger">{{ $errors->first('tipe_pembayaran') }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label for="nomor_rekening">Nomor Pembayaran</label>
